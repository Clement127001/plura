...
const LandingPage = () => {
  return (
    <>
      <section className="h-full w-full relative flex items-center justify-center flex-col pt-20">
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-20 mt-[-60px]">
        ...
        <div className="flex  justify-center gap-4 flex-wrap mt-6">
          {/* TODO: will be uncommented when the price env is added - in stripe */}
